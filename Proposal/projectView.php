                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php echo $time ?></td>
                                <td><?php echo $skil ?></td>
                                <td><a href='Proposal.php?id=<?php echo $id ?>&name=<?php echo urlencode($name) ?>&description=<?php echo urlencode($description) ?>&budget=<?php echo $budget ?>&date=<?php echo $date ?>&time=<?php echo $time ?>&skil=<?php echo urlencode($skil) ?>' class='btn btn-primary'>Bids</a></td>
