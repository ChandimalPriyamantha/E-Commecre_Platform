<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="card text-center">
            ...
            <div class="card-body">
                <a href="add_category_form.php" ><button type='button' class='btn btn-success btn-sm' style="float:right;"><lable style='color:white' >Add category</lable></button></a><br><br>
