...
update Worker set  Image_Path="Worker_images/Screenshot (11).png"  where ID=696; 
...
update Phone_Number_of_worker set Mobile_Number='0713828301' where ID=696;
insert into Phone_Number_of_worker (ID,Mobile_Number,Worker_ID) values(4,'0713828301',696);
